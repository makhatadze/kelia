...
{{--                        <img src="{{ asset('images/logo/webapp_logo.png') }}" alt="webapp logo">--}}
{{--                    </span>--}}

                    <h2 class="brand-text">{{ config('admin.title') }}</h2>
                </a>
            </li>
                        ...
                        <li class="nav-item {{ $custom_classes }} {{Route::currentRouteName() === $menu->slug ? 'active' : ''}}">
                            ...
                            >
                                ...
                                @if (isset($menu->badge))
                                    ...
                                    <span class="{{ isset($menu->badgeClass) ? $menu->badgeClass : $badgeClasses }}">
                                        {{$menu->badge}}
                                    </span>
                                @endif
                            </a>
